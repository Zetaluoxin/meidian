				...
				<div class="row">
					...
					<div class="col-xs-12">
						...
						<div class="table-responsive">
							<table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable company" aria-describedby="sample-table-2_info">
								<thead>
									<tr role="row">
										...
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending" style="width: 117px;">店主</th>
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending" style="width: 117px;">店铺名称</th>
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Price: activate to sort column ascending" style="width: 97px;">店铺地址</th>
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending" style="width: 117px;">终端数量</th>
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending" style="width: 117px;">正常运行</th>
							...
							<tbody role="alert" aria-live="polite" aria-relevant="all">
								<?php if(is_array($barbershop)): foreach($barbershop as $key=>$b): ?><tr class="odd" name="<?php echo ($b["id"]); ?>">
										...
										<td class=" "><?php echo (getUser($b["user_id"])); ?></td>
										<td class=" ">
											<?php echo ($b["barbershop_name"]); ?>
										</td>
										<td class=" "><?php echo (getProvince($b["barbershop_province"])); ?></td>
										<td class=" "><?php echo (getProductNum($b["id"])); ?></td>
										<td class=" "><?php echo (getProductRun($b["id"])); ?></td>

										<td class=" ">
											<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">

												<a class="green" href="http://localhost/meidian/index.php/Admin/Index/updateBarbershop?id=<?php echo ($b["id"]); ?>&user_id=<?php echo ($b["user_id"]); ?>&barbershop_name=<?php echo ($b["barbershop_name"]); ?>&province_id=<?php echo ($b["barbershop_province"]); ?>&city_id=<?php echo ($b["barbershop_city"]); ?>&district_id=<?php echo ($b["barbershop_district"]); ?>&street_id=<?php echo ($b["barbershop_street"]); ?>">
													<i class="icon-pencil bigger-130"></i>
													编辑
												</a>

												<a class="red delcompany" href="javascript:void(0)">
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				$('table th input:checkbox').on('click' , function(){
					var that = this;
					$(".company").find('tr > td:first-child input:checkbox')
					.each(function(){
				...
				function search(){
					$(".search").click(function(){
						var sec = $("#filed").val();
						var ipt = $(".content").val();
						window.location.href = app+"/Admin/Index/getBarbershop?"+sec+"="+ipt;
					});
				}	
				search();
			});
