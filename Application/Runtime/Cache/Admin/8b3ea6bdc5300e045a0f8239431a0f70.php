				...
				<ul class="nav nav-list">
					...
					<li>
						<a href="javascript:void(0)">
							...
							<span class="menu-text"> 暂时没有 </span>
						</a>
					</li>
					...
					<li>
						...
						<ul class="submenu">
							...
							<li>
								<a href="http://localhost/meidian/index.php/Admin/Index/updateUser">
									<i class="icon-double-angle-right"></i>
									编辑用户
								</a>
							</li>
					...
					<li>
						...
						<ul class="submenu">
							...
							<li>
								<a href="http://localhost/meidian/index.php/Admin/Index/updateFile">
									<i class="icon-double-angle-right"></i>
									编辑素材
								</a>
							</li>
							...
							<li>
								<a href="http://localhost/meidian/index.php/Admin/Index/delFile">
									<i class="icon-double-angle-right"></i>
									删除素材
								</a>
							</li>
