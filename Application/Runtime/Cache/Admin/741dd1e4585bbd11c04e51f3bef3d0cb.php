					...
					<div class="col-xs-12">
						<div class="form-horizontal" role="form">
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="广告主名称" class="col-xs-10 col-sm-5" name="com_name">
								</div>
							</div>
							<div class="form-group">
		...
		<option value="">请选择理发店</option>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn btn-info addcompany" type="button">
