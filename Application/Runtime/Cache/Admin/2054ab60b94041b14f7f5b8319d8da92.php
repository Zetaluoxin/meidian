				...
				<div class="row">
					<div class="col-xs-12">
						<div class="form-horizontal" role="form" id="divform" name="<?php echo ($a["id"]); ?>">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 广告上架 </label>

								<div class="col-sm-9" style="font-size: 18px">
									<select class="chosen-select" id="status" name="">
											<option value="">&nbsp;</option>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn btn-info updateadvert" type="button" id="sure">
									<i class="icon-ok bigger-110"></i>
									确定
								</button>
								<button class="btn btn-info updateadvert" type="button" id="push">
									<i class="icon-ok bigger-110"></i>
									推送
								</button>
							</div>
		...
		<script type="text/javascript">
			...
			window.onload = function(){
				 $("#sure").click(function(){
				 	...
				 	$.ajax({
				 		"url":app+"/Admin/Advert/statusAdvert",
			            "type":"post",
			            "data":{"id":advert_id,"ad_status":status},
