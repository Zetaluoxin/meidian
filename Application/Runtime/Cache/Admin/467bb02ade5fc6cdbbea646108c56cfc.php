				...
				<div class="row">
					<div class="form-group">
						...
						<select class="col-sm-1" id="filed" style="width: 130px;">
							...
							<?php if($search['com_name']) echo 'selected'; ?>
							>广告主名</option>
							<option value="place"
					...
					<div class="col-xs-12">
						...
						<div class="table-responsive">
							<table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable company" aria-describedby="sample-table-2_info">
								<thead>
									<tr role="row">
										...
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending" style="width: 117px;">管理员</th>
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending" style="width: 117px;">公司名称</th>
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Price: activate to sort column ascending" style="width: 97px;">联系方式</th>
							...
							<tbody role="alert" aria-live="polite" aria-relevant="all">
								<?php if(is_array($company)): foreach($company as $key=>$c): ?><tr class="odd" name="<?php echo ($c["id"]); ?>">
										...
										<td class=" "><?php echo (getUser($c["user_id"])); ?></td>
										<td class=" ">
											<?php echo ($c["com_name"]); ?>
										</td>
										<td class=" "><?php echo (getProvince($c["province_id"])); ?></td>

										<td class=" ">
											<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">

												<a class="green" href="http://localhost/meidian/index.php/Admin/Index/updateCompany?id=<?php echo ($c["id"]); ?>&user_id=<?php echo ($c["user_id"]); ?>&com_name=<?php echo ($c["com_name"]); ?>&province_id=<?php echo ($c["province_id"]); ?>&city_id=<?php echo ($c["city_id"]); ?>&district_id=<?php echo ($c["district_id"]); ?>&street_id=<?php echo ($c["street_id"]); ?>&barbershop_id=<?php echo ($c["barbershop_id"]); ?>">
			...
			jQuery(function($) {
				...
				function search(){
					$(".search").click(function(){
						var sec = $("#filed").val();
						var ipt = $(".content").val();
						window.location.href = app+"/Admin/Index/getCompany?"+sec+"="+ipt;
					});
				}	
				search();
			});
