	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="form-horizontal form" role="form" name="<?php echo ($barbershop["id"]); ?>">
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 店铺名称 </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="店铺名称" class="col-xs-10 col-sm-5" name="barbershop_name" value="<?php echo ($barbershop["barbershop_name"]); ?>">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div id="place_select">
										<select class="width-20 " id="form-field-select-3" name="province">
											...
											<?php if($barbershop['province_id'] == $pro['id']){echo 'selected';} ?>
											><?php echo ($pro["province_name"]); ?></option><?php endforeach; endif; ?>
										</select>
										<select class="width-20 " id="form-field-select-1" name="city">
											<option value="">请选择城市</option>	
											<?php if($barbershop['city_id']){ echo "<option value=".$barbershop['city_id']." selected>".getCity($barbershop['city_id'])."</option>"; } ?>	
										</select>
										<select class="width-20 " id="form-field-select-3" name="district">
											<option value="">请选择区/县</option>
											<?php if($barbershop['district_id']){ echo "<option value=".$barbershop['district_id']." selected>".getDistrict($barbershop['district_id'])."</option>"; } ?>
										</select>
										<select class="width-20 " id="form-field-select-3" name="street">
											<option value="">请选择街道/村</option>
											<?php if($barbershop['street_id']){ echo "<option value=".$barbershop['street_id']." selected>".getStreet($barbershop['street_id'])."</option>"; } ?>
										</select>
									</div>
								</div>
							</div>
								...
								<div class="col-sm-9">
									<div>
										<select class="width-80 chosen-select" id="form-field-select-3" data-placeholder="Choose a Country..." style="display: none;" name="user_id">
											...
											<?php if($barbershop['user_id'] == $u['id']){echo 'selected';} ?>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn btn-info updateBarbershop" type="button">
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			function updateBarbershop(){
				$(".updateBarbershop").click(function(){
					...
					if(barbershop_name == '' || user_id == ''){
						return dialog.error("请输入完整信息！");
					}
					$.ajax({
						"url":app+"/Admin/Barbershop/updateBarbershop",
						"type":"post",
						"data":{
							"id":id,
