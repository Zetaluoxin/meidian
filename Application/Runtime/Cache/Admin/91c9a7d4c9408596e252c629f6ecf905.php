					...
					<div class="col-xs-12">
						<div class="form-horizontal" role="form">
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="终端编号" class="col-xs-10 col-sm-5" name="product_batch">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> MAC编码 </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="MAC编码" class="col-xs-10 col-sm-5" name="product_maccode">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div>
										<select class="width-80 chosen-select" id="form-field-select-3" data-placeholder="Choose a Country..." style="display: none;" name="product_type">
											<option value="">&nbsp;</option>
											<option value="单面机">单面机</option>
											<option value="双面机">双面机</option>
											<option value="挂式机">挂式机</option>
										</select>
									</div>
								</div>
							</div>
		...
		<script type="text/javascript">
			...
			function addproduct(){
				$(".addproduct").click(function(){
					var product_batch = $("[name=product_batch]").val();
					var product_maccode = $("[name=product_maccode]").val();
					...
					if(product_batch == '' || product_maccode == ''){
						return dialog.error("请录入完整信息!");
					}
					$.ajax({
						"url":app+"/Admin/Product/addProduct",
						"type":"post",
						"data":{
							"product_batch":product_batch,
							"product_maccode":product_maccode,
