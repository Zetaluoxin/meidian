		...
		<div class="main-content">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="breadcrumb">
					...
					<li>
						<a href="#"><?php echo getUser(session('uid')); ?></a>
					</li>
					...
					<div class="col-xs-12">
						<div class="form-horizontal" role="form">
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 姓名 :</label><div class="col-sm-3 lh"><?php $res=getUserInfo(session('uid'));echo $res[0]['names']; ?></div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 昵称 :</label><div class="col-sm-3 lh"><?php $res=getUserInfo(session('uid'));echo $res[0]['nickname']; ?></div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> QQ :</label><div class="col-sm-3 lh"><?php $res=getUserInfo(session('uid'));echo $res[0]['qq']; ?></div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 手机 :</label><div class="col-sm-3 lh"><?php $res=getUserInfo(session('uid'));echo $res[0]['telephonenum']; ?></div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 最后登录的时间 :</label><div class="col-sm-3 lh"><?php $res=getUserInfo(session('uid'));echo $res[0]['logintime']; ?></div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 最后登录的ip :</label><div class="col-sm-3 lh"><?php $res=getUserInfo(session('uid'));echo $res[0]['lastloginip']; ?></div>
							</div>
						</div><!--表单组-->
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn btn-info adduser" type="button">
									...
									<a href='http://localhost/meidian/index.php/admin/index/updatePassword'>修改密码</a>
								</button>

								&nbsp; &nbsp; &nbsp;
								<button class="btn btn-info adduser" type="reset">
									<i class="icon-undo bigger-110"></i>
									<a href='http://localhost/meidian/index.php/admin/index/updateUserInfo'>修改资料</a>
								</button>
							</div>
						</div>
					</div><!--col-xs-12-->
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			var heigt=$('label').outerHeight();
			console.log(heigt);
			$('.lh').css('line-height',heigt+'px');
