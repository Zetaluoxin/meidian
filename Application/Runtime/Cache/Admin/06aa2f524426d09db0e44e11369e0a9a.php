	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="form-horizontal form" role="form" name="<?php echo ($product["id"]); ?>">
								...
								<div class="col-sm-9">
									<div id="place_select">
										<select class="width-20 " id="form-field-select-3" name="province">
											...
											<?php if($product['province_id'] == $pro['id']){echo 'selected';} ?>
											><?php echo ($pro["province_name"]); ?></option><?php endforeach; endif; ?>
										</select>
										<select class="width-20 " id="form-field-select-1" name="city">
											<option value="">请选择城市</option>	
											<?php if($product['city_id']){ echo "<option value=".$product['city_id']." selected>".getCity($product['city_id'])."</option>"; } ?>	
										</select>
										<select class="width-20 " id="form-field-select-3" name="district">
											<option value="">请选择区/县</option>
											<?php if($product['district_id']){ echo "<option value=".$product['district_id']." selected>".getDistrict($product['district_id'])."</option>"; } ?>
										</select>
										<select class="width-20 " id="form-field-select-3" name="street">
											<option value="">请选择街道/村</option>
											<?php if($product['street_id']){ echo "<option value=".$product['street_id']." selected>".getStreet($product['street_id'])."</option>"; } ?>
										</select>
										<select class="width-20 " id="form-field-select-3" name="barbershop">
											<option value="">请选择理发店</option>
											<?php if($product['barbershop_id']){ echo "<option value=".$product['barbershop_id']." selected>".getShopname($product['barbershop_id'])."</option>"; } ?>
										</select>
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div>
										<select class="width-80 chosen-select" id="form-field-select-3" data-placeholder="Choose a Country..." style="display: none;" name="product_fix">
											<option value="">&nbsp;</option>
											<option value="0"
											<?php if($product['product_fix'] == 0){echo 'selected';} ?>
											>报修</option>
											<option value="1"
											<?php if($product['product_fix'] == 1){echo 'selected';} ?>
											>正常</option>
										</select>
									</div>
								</div>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn btn-info updateproduct" type="button">
