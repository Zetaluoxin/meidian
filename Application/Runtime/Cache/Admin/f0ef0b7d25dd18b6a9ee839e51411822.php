	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="form-horizontal user_form" role="form" name="<?php echo ($user["id"]); ?>">
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 昵称 </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="名称不得超过八个汉字的长度" class="col-xs-10 col-sm-5" name="nickname" value="<?php echo ($user["nickname"]); ?>">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="format" class="col-xs-10 col-sm-5" name="names" value="<?php echo ($user["names"]); ?>">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="qq" class="col-xs-10 col-sm-5" name="qq" value="<?php echo ($user["qq"]); ?>">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="phonenum" class="col-xs-10 col-sm-5" name="telephonenum" value="<?php echo ($user["telephonenum"]); ?>">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="postalcode" class="col-xs-10 col-sm-5" name="postalcode" value="<?php echo ($user["postalcode"]); ?>">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div id="place_select">
										<select class="width-20 " id="form-field-select-3" name="province">
											...
											<?php if($user['province_id'] == $pro['id']){echo 'selected';} ?>
											><?php echo ($pro["province_name"]); ?></option><?php endforeach; endif; ?>
										</select>
										<select class="width-20 " id="form-field-select-1" name="city">
											<option value="">请选择城市</option>		
											<?php if($user['city_id']){ echo "<option value=".$user['city_id']." selected>".getCity($user['city_id'])."</option>"; } ?>
										</select>
										<select class="width-20 " id="form-field-select-3" name="district">
											<option value="">请选择区/县</option>
											<?php if($user['district_id']){ echo "<option value=".$user['district_id']." selected>".getDistrict($user['district_id'])."</option>"; } ?>
										</select>
										<select class="width-20 " id="form-field-select-3" name="street">
											<option value="">请选择街道/村</option>
											<?php if($user['street_id']){ echo "<option value=".$user['street_id']." selected>".getStreet($user['street_id'])."</option>"; } ?>
										</select>
									</div>
								</div>
							</div>
...
<![endif]-->
		...
		<script src="http://localhost/meidian/Public/Js/updateUser.js"></script>
